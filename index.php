    ...
    <div class="container-fluid m-0 p-0">
      <div class="bg-dark mt-4">
        <header class="bg-info text-center fixed-top">
          <h6>
            Spreading Love and Purity in the Metaverse.<span
                    ...
                    <ul class="navbar-nav">
                      <li class="nav-item">
                        <a
                          ...
                          id="home"
                          class="nav-link active pr-3 text-warning"
                          aria-current="page"
                          href="#"
                          >Home</a
                        >
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-7 col-md-7 col-7 p-4">
              ...
              <span id="span" style="color: #36d3a2; font-weight: 700"
                >PURITY AND GROWTH AWAITS</span
              >
              <div id="head">
                <h1>How to Become</h1>
            ...
            <div class="col-lg-6 col-md-12 col-12 p-0">
              ...
              <span
                style="
                  ...
                  padding: 3px;
                "
                ><span style="visibility: hidden">me</span></span
              ><a href="" id="create"
                ><span
                  style="margin-left: -15px; color: #fffdfc; font-size: 0.8em"
                  >CREATE NOW <span style="font-size: 20px">&#8702;</span></span
                ></a
              >
            </div>
        ...
        <div class="container-fluid text-center border-right">
          <div class="row">
            <div class="col-lg-4 pl-1">
              <div
                class="row bg"
                style="background-color: #14ed96; border-right-style: solid"
              >
                <div class="col-lg-8">
      ...
      <section class="bg-dark">
        ...
        <div class="container py-5 px-5 justify-content-center">
          <div class="row no-gutters">
            <div
              class="col-lg-6 col-md-6 py-4 d-flex justify-content-center"
            ...
            <div
              class="col-lg-6 col-md-6 pl-0 pr-5 d-flex justify-content-start"
            >
              <img
                src="image/globe.png"
                alt=""
          ...
          <div class="container text-center mt-5">
              <div class="row justify-content-center">
                  <div class="col-md-6">
                    <a
                    href=""
                    class="btn btn-warning px-2 py-1 mb-5"
                    ><h6 style="font-size: smaller;">JOIN DISCORD</h6></a
                  >
                  </div>
              </div>
          </div>
